...
- [configure command](../reference/configure) — Profile configuration details
- [Supported AI Providers](../configure/providers) — Provider setup guides
- [Environment Variables](../configure/envvars) — Environment-based configuration
- [Session Management](./sessions) — Using profiles with sessions
