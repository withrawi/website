...
1. **Learn the Basics**: Check out the [Quick Start Guide](./quickstart)
2. **Explore Commands**: Read the [Commands Reference](../reference)
3. **Set Up Multiple Providers**: Learn about [Profile Management](../advanced/profiles)
4. **Try Templates**: Explore [Act Templates](../configure/act-templates)
5. **Advanced Usage**: Discover [Shell Integration](../advanced/shell-integration)

---

## Need Help?

- **Troubleshooting**: Check our [Troubleshooting Guide](../help/troubleshooting)
- **FAQ**: Browse [Frequently Asked Questions](../help/faq)
...
- [AI Providers](../configure/providers)
