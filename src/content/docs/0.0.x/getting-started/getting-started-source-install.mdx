---
title: Rawi (راوي) Documentation | Getting Started Building and installing the
  rawi CLI from source
...
slug: 0.0.x/getting-started/getting-started-source-install
---
