...
<TabItem label="Show Template Details">
  ```bash $ rawi ask --act code-review --show 🎭 Act Template: Code Review ID:
  code-review Category: Code Review Template: "You are a code reviewer. Review
  the following code for bugs and improvements." ```
</TabItem>
