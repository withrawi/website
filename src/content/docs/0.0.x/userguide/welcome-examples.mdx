...
slug: 0.0.x/userguide/welcome-examples
---
...
* **Replaceable Text** – Variable text (such as file names, profile names, or API keys) is shown in *italic* or `<angle brackets>`. Replace these with your own values.
