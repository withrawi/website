...
- [ask command](../reference/ask) — Command reference
- [Act Templates Guide](../configure/act-templates) — Template details
- [Session Management](./sessions) — Managing conversations
- [Shell Integration](./shell-integration) — Automation patterns
- [Workflows](../workflows) — Complete workflow examples
