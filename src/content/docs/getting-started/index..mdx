...
| DeepSeek       | DeepSeek account, API key                   | Get API key from [DeepSeek Platform](https://platform.deepseek.com/api_keys)          |
| Mistral        | Mistral account, API key                    | Get API key from [Mistral Console](https://console.mistral.ai/api-keys/)              |
| Cerebras       | Cerebras account, API key                   | Get API key from [Cerebras Cloud](https://cloud.cerebras.ai)                          |
| Ollama (local) | None (runs locally)                         | Install [Ollama](https://ollama.ai/) and pull models                                  |
| LM Studio      | None (runs locally)                         | Install [LM Studio](https://lmstudio.ai/) and download models                         |
