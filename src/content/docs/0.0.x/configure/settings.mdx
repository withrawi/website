...
<Steps>
  1. **Switch and use a profile in one command:** `bash rawi configure   --profile work --provider anthropic --model claude-3-sonnet-20240229 --api-key
