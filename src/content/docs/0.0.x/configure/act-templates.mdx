...
Rawi CLI provides advanced features for customizing your AI interactions, including **Act Templates** for prompt engineering and **Profiles** for managing multiple provider configurations. These features enable you to tailor your AI experience for different projects, teams, or workflows—directly from your terminal.
