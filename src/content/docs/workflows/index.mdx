...
- [**Technical Writing Workflow**](#technical-writing-workflow) — Create comprehensive technical documentation
- [**Blog Content Pipeline**](#blog-content-workflow) — Research, write, and optimize blog posts
- [**API Documentation**](#api-documentation-workflow) — Generate and maintain API docs
- [**Marketing Content**](#marketing-content-workflow) — Create marketing materials and copy
...
- [Development Workflow](development) — Detailed development patterns
- [Content Creation Workflow](content-creation) — Writing and documentation
- [Research Workflow](research) — Analysis and research patterns
- [Shell Integration](../advanced/shell-integration) — Technical automation details
- [Usage Patterns](../advanced/usage) — General usage best practices
